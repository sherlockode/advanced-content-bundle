...
{
    public function __construct(private readonly ConfigurationManager $configurationManager, private readonly ScopeHandlerInterface $scopeHandler, private readonly TranslatorInterface $translator)
    {
    }
