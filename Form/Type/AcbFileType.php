...
{
    public function __construct(private readonly UploadManager $uploadManager, private readonly EventDispatcherInterface $eventDispatcher, private readonly MimeTypeManager $mimeTypeManager)
    {
    }
