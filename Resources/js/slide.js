...
{
    constructor() {
        this.element = $('<div class="acb-lateral-slide"><button type="button" class="btn-close">x</button><div class="acb-lateral-slide-header"></div><div class="acb-lateral-slide-content"></div></div>');
